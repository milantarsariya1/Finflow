...
import { Plus, Trash, Wallet, Landmark, PiggyBank, PlusCircle, ArrowRight, ListPlus } from 'lucide-react';
      ...
      <div className="max-w-4xl w-full bg-white border border-slate-200 dark:bg-dark-panel dark:border-dark-border rounded-3xl p-6 md:p-10 shadow-2xl relative z-10 animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className="space-y-8 text-left">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            {/* Right Column: Fixed Expenditures */}
            <div className="flex flex-col justify-between">
              ...
              {/* Obligations Summary */}
              <div className="bg-slate-50 border border-slate-200 dark:bg-dark-card/50 dark:border-dark-border/50 rounded-2xl p-4.5 mt-5">
